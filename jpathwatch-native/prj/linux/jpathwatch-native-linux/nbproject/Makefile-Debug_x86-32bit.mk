...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ../../../dist/Debug/GNU-Linux-x86/libjpathwatch-native.so

../../../dist/Debug/GNU-Linux-x86/libjpathwatch-native.so: ${OBJECTFILES}
	${MKDIR} -p ../../../dist/Debug/GNU-Linux-x86
	${LINK.cc} -shared -o ../../../dist/Debug/GNU-Linux-x86/libjpathwatch-native.so -fPIC ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ../../../dist/Debug/GNU-Linux-x86/libjpathwatch-native.so
