...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Debug_32bit.mk ../../../dist/Debug/Windows-x86/jpathwatch-native.dll

../../../dist/Debug/Windows-x86/jpathwatch-native.dll: ${OBJECTFILES}
	${MKDIR} -p ../../../dist/Debug/Windows-x86
	${LINK.cc} -Wl,--add-stdcall-alias -shared -o ../../../dist/Debug/Windows-x86/jpathwatch-native.dll ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Debug_32bit
	${RM} ../../../dist/Debug/Windows-x86/jpathwatch-native.dll
