...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Release_64bit.mk ../../../dist/Release/Windows-amd64/jpathwatch-native.dll

../../../dist/Release/Windows-amd64/jpathwatch-native.dll: ${OBJECTFILES}
	${MKDIR} -p ../../../dist/Release/Windows-amd64
	${LINK.cc} -Wl,--add-stdcall-alias -shared -o ../../../dist/Release/Windows-amd64/jpathwatch-native.dll ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release_64bit
	${RM} ../../../dist/Release/Windows-amd64/jpathwatch-native.dll
