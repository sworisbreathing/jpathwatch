...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ../../../dist/Release/${CND_PLATFORM}/libjpathwatch-native-32.dylib

../../../dist/Release/${CND_PLATFORM}/libjpathwatch-native-32.dylib: ${OBJECTFILES}
	${MKDIR} -p ../../../dist/Release/${CND_PLATFORM}
	${LINK.cc} -dynamiclib -install_name libjpathwatch-native-32.dylib -o ../../../dist/Release/${CND_PLATFORM}/libjpathwatch-native-32.dylib -fPIC ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ../../../dist/Release/${CND_PLATFORM}/libjpathwatch-native-32.dylib
